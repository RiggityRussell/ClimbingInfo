...
namespace ClimbingInfo.Controllers
{
    public class GearsController : Controller
    {
        ...
        public GearsController(ClimbingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("GearId,SetupName,Shoes,Harness,Chalk_Bag")] Gear gear)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GearId,SetupName,Shoes,Harness,Chalk_Bag")] Gear gear)
        {
            if (id != gear.GearId)
            {
                return NotFound();
