...
namespace ClimbingInfo.Controllers
{
    public class ExperiencesController : Controller
    {
        ...
        public ExperiencesController(ClimbingContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ExperienceId,ExperienceName,years,freq")] Experience experience)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ExperienceId,ExperienceName,years,freq")] Experience experience)
        {
